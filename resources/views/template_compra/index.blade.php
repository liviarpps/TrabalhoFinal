        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesM" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a type="filtro" name="filtro" class="collapse-item" href="/filtro/marca/Nenhum">Todas</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesC" class="collapse" aria-labelledby="headingPages"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a type="filtro" name="filtro" class="collapse-item" href="/filtro/categoria/Nenhum">Todas</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePagesCor" class="collapse" aria-labelledby="headingPages"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a type="filtro" name="filtro" class="collapse-item" href="/filtro/cor/Nenhum">Todas</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Lojinha</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
